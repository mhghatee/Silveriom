...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'new_jewell_finish_6f82754a80e3ec472266_20260726162720_archive.zip';
        const ARCHIVE_SIZE       = '85553957';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '6f82754-26162720';
        const SECONDARY_PACKAGE_HASH = '2ff2a56-26162720';
