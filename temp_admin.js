...
function handleDirectFileUpload(fileInput, targetInputId, previewImgId) {
  ...
  reader.onload = async (e) => {
    ...
    showToast('تصویر آماده ذخیره‌سازی است (Base64)', 'success');
...
function renderAudience() {
  ...
  setVal('aud-stat1-label', aud.stat1 ? aud.stat1.label : undefined);
  setVal('aud-stat1-value', aud.stat1 ? aud.stat1.value : undefined);
  setVal('aud-stat2-label', aud.stat2 ? aud.stat2.label : undefined);
  setVal('aud-stat2-value', aud.stat2 ? aud.stat2.value : undefined);
}
